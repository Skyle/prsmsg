    ...
    <div>
      <div>
        {res.data?.map((message) => {
          return (
            <div className="w-[300px] h-[100px] rounded-3xl  ml-100px mt-100px relative bg-white pt-6 m-10 text-black text-center translate-y-68 duration-500 transition-all">
              {message.text}
              <div
                className=" px-2 py-3 m-1 -top-8 -left-4 bg-white text-black w-[120px] absolute rounded-full"
                key={message.id}
              >
